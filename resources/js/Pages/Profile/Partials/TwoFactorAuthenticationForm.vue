<template>
    <jet-action-section>
        ...
        <template #description>
            Adicione segurança adicional à sua conta usando autenticação em dois fatores.
        </template>
                ...
                <div v-if="qrCode">
                    <div class="max-w-xl mt-4 text-sm text-gray-600">
                        <p class="font-semibold">
                            A autenticação de dois fatores agora está habilitada. Digitalize o código QR a seguir usando o aplicativo autenticador do seu telefone.
                        </p>
                    </div>
