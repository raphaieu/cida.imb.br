            ...
            <div class="mt-4" v-if="$page.props.jetstream.hasTermsAndPrivacyPolicyFeature">
                <jet-label for="terms">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2">
                            Estou de acordo com os <a target="_blank" :href="route('terms.show')" class="text-sm text-gray-600 underline hover:text-gray-900">Termos de uso</a> e <a target="_blank" :href="route('policy.show')" class="text-sm text-gray-600 underline hover:text-gray-900">Política de Privacidade.</a>
                        </div>
                    </div>
                </jet-label>
            </div>
