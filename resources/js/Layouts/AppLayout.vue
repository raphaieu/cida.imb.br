                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('dashboard')" :active="isConfiguracaoActive()">
                                    Configurações
                                </jet-nav-link>
                                <jet-nav-link :href="route('imovel.index')" :active="route().current('imovel.index')">
                                    Imóveis
                                </jet-nav-link>
                            </div>
                        </div>
...
export default defineComponent({
    ...
    methods: {
        ...
        isConfiguracaoActive() {
            let config = false;
            const menu = route().current().split('.');
            switch (menu[0]) {
                case 'dashboard':
                case 'corretor':
                case 'negocio':
