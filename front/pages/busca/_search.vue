        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Resultado da Busca</h1>
              <span class="color-text-a">Foram encontrados XX imóveis que corresponde com os termos de pesquisa</span>
            </div>
          </div>
            ...
            <div class="grid-option">
              <form>
                <select class="custom-select">
                  ...
                  <option value="2">Para Aluguel</option>
...
export default {
  ...
  head() {
    return {
      title: `Resultado da Busca para: XYZ | Cida Imóveis`,
    //   meta: [{
    //     hid: 'description',
    //     name: 'description',
